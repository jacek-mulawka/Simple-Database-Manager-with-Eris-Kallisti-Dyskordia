object View__Modify_Form: TView__Modify_Form
  Left = 0
  Top = 0
  ...
  object Centre_Panel: TPanel
    ...
    Align = alClient
    TabOrder = 1
    object View_Source_Horizontal_Splitter: TSplitter
      Left = 1
      Top = 171
      Width = 602
      Height = 6
    ...
    object View_Parameters_GroupBox: TGroupBox
      AlignWithMargins = True
      Left = 11
      Top = 1
      Width = 582
      ...
      object View_Parameter_Panel: TPanel
        Left = 470
        Top = 17
        Width = 110
        Height = 151
        ...
        object View__Parameter__Align_Correct_Button: TButton
          Left = 10
          Top = 5
          Width = 20
          Height = 20
          ...
          ShowHint = True
          TabOrder = 0
          OnClick = View__Parameter__Align_Correct_ButtonClick
        end
      end
      object View_Parameters__List_ScrollBox: TScrollBox
        Left = 2
        Top = 17
        Width = 462
        Height = 151
    ...
    object View_Source_GroupBox: TGroupBox
      Left = 1
      Top = 177
      Width = 602
      Height = 120
      ...
      object View__Source_Memo: TMemo
        ...
        OnKeyDown = View__Source_MemoKeyDown
  ...
  object View_Source__SynCompletionProposal: TSynCompletionProposal
    ...
    Resizeable = True
    ShortCut = 16416
    Editor = View__Source_SynEdit
    OnAfterCodeCompletion = View_Source__SynCompletionProposalAfterCodeCompletion
    OnCodeCompletion = View_Source__SynCompletionProposalCodeCompletion
    Left = 492
    Top = 241
  end
end
