...
type
  ...
  TTranslation__Messages_r = record
    ...
    reset_search_from_the_beginning,
    reset_search_from_the_end,
...
begin
  ...
  Translation__Unit__Add( 'TDatabase__Modify_Form' );
    ...
    Translation__Component__Add( 'Stored_Procedures_List__Search_Edit', '', 'Enter - open.' );
    ...
    Translation__Component__Add( 'Stored_Procedures_List__Search__Next_Button', '', 'Search next.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
    Translation__Component__Add( 'Stored_Procedures_List__Search__Partial_Key_CheckBox', 'Partial key' );
    Translation__Component__Add( 'Stored_Procedures_List__Search__Prior_Button', '', 'Search prior.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
    ...
    Translation__Component__Add( 'Tables_List__Search_Edit', '', 'Enter - open.' );
    ...
    Translation__Component__Add( 'Tables_List__Search__Next_Button', '', 'Search next.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
    Translation__Component__Add( 'Tables_List__Search__Partial_Key_CheckBox', 'Partial key' );
    Translation__Component__Add( 'Tables_List__Search__Prior_Button', '', 'Search prior.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
    ...
    Translation__Component__Add( 'Views_List__Search_Edit', '', 'Enter - open.' );
    ...
    Translation__Component__Add( 'Views_List__Search__Next_Button', '', 'Search next.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
    Translation__Component__Add( 'Views_List__Search__Partial_Key_CheckBox', 'Partial key' );
    Translation__Component__Add( 'Views_List__Search__Prior_Button', '', 'Search prior.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - open]' );
  ...
  Translation__Unit__Add( 'TOptions_Form' );
    ...
    Translation__Component__Add( 'Cancel_Button', 'Cancel' );
    Translation__Component__Add( 'Csv_File_GroupBox', 'Csv file' );
    Translation__Component__Add( 'Csv_File__Data_Separator_GroupBox', 'Data separator', 'Data separator.' );
    Translation__Component__Add( 'Csv_File__Text_Qualifier_GroupBox', 'Text qualifier', 'Text qualifier.' );
    ...
    Translation__Component__Add( 'Sql_Editor__Code_Completion_Window__Default__Lines_In_Window_GroupBox', 'Lines in window' );
    Translation__Component__Add( 'Sql_Editor__Code_Completion_Window__Default__Width_GroupBox', 'Default width' );
    Translation__Component__Add( 'Sql_Editor__Code_Completion_Window_GroupBox', 'Code completion window' );
  ...
  Translation__Unit__Add( 'TSimple_Database_Manager_Form' );
    ...
    Translation__Component__Add( 'Databases__Edit_MenuItem', 'Edit list [Space, Ctrl + Enter]' );
    Translation__Component__Add( 'Databases__Edit_2_MenuItem', 'Edit list [Space, Ctrl + Enter]' );
  ...
  Translation__Unit__Add( 'TSql_Editor_F_Frame' );
    ...
    Translation__Component__Add( 'Csv_File__Data_Separator_Edit', '', 'Csv data separator.' );
    Translation__Component__Add( 'Csv_File__Text_Qualifier_Edit', '', 'Csv text qualifier.' );
    ...
    Translation__Component__Add( 'Refresh_Button', '', 'Refresh.' + #13 + #10 + #13 + #10 + '[Ctrl + R]' );
    Translation__Component__Add( 'Search_Edit', '', 'Enter - add.' );
    Translation__Component__Add( 'Search_GroupBox', 'Search' );
    Translation__Component__Add( 'Search_In_RadioGroup', 'Search in', 'Columns list' + #13 + #10 + 'Query output' + #13 + #10 + 'Tables list', 'Col;Que;Tbl;' );
    Translation__Component__Add( 'Search__Case_Insensitive_CheckBox', 'Case insensitive' );
    Translation__Component__Add( 'Search__Next_Button', '', 'Search next.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - add]' );
    Translation__Component__Add( 'Search__Partial_Key_CheckBox', 'Partial key' );
    Translation__Component__Add( 'Search__Prior_Button', '', 'Search prior.' + #13 + #10 + #13 + #10 + '[Ctrl + Enter - add]' );
  ...
  Translation__Unit__Add( 'TTable__Data_Modify_F_Frame' );
    ...
    Translation__Component__Add( 'Extract_Table_Data_Button', '', 'Extract table data to log.' + #13 + #10 + #13 + #10 + 'Multiple extracts in background may case the application to freeze.' );
    ...
    Translation__Component__Add( 'Search__Partial_Key_CheckBox', 'Partial key' );
    Translation__Component__Add( 'Search__Prior_Button', '', 'Search prior.' );
    Translation__Component__Add( 'Table_Column__Values_Distinct_Button', '', 'Column distinct values.' );
  ...
  translation__messages_r.delete_visible_records := 'Delete visible records?';
  ...
  translation__messages_r.help__keyboard_shortcuts :=
    ...
    '    Ctrl + Enter - add all columns in the SQL editor' + #13 +
    '    Ctrl + F - find (search) text' + #13 +
    '    Ctrl + H - replace text' + #13 +
    '    Enter, Double-click - add column in the SQL editor' + #13 +
    '    F3 - find (search) / replace text';
  ...
  translation__messages_r.reset_search_from_the_beginning := 'Reset search from the beginning?';
  translation__messages_r.reset_search_from_the_end := 'Reset search from the end?';
  ...
  translation__messages_r.word__column_name := 'Column name';
  ...
  translation__messages_r.word__default_value := 'Default value';
  ...
  translation__messages_r.word__user_name := 'User name';
